...
// 각각의 상춤을 저장하는 클래스가 별도로 존재함

// 1. Apple 클래와 Apple클래스를 담을 수 있는 클래스
class Apple{} 	// 클래스 선언
class Goods1{	// 상품 클래스, Apple 상품을 담는 클래스 
	//접근 제어자가 private이기 때문에 외부에서 apple참조 변수에 값을 넣거나 가져오기 위해서는
...
public class ProbleamsBeforeGeneric {
	public static void main(String[] args) {
		...
		goods2.setPencil(new Pencil());		// setter를 사용해서 Pencil객체를 추가
