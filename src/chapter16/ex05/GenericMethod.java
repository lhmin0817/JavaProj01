...
class GenericMrthods{
	...
	// 동일한 타입의 두 값을 인풋받아서 같으면 true 다르면 false를 리턴
	//	제너릭에 넣은 타입 변수 T 에 올수 있는 것은 기본타입은 넣을 수 없다. wrapper 클래스만 올 수 잇다.
...
public class GenericMethod {
	public static void main(String[] args) {
		...
		//제너릭 메소드 사용 
		//일반 클래스의 객체 생성
		GenericMrthods gm= new GenericMrthods();
		String st1=gm.<String>method1("안녕");
		String st2=gm.method1("하세요");			//뒤의 인풋 값으로 타입을 유추할 수 있는 경우 생략가능
		...
		gm.method3("아바타", "롯데시네마");
		gm.method3(1000, 2000);
		gm.<Integer, Double>method3(1000, 1000.);
