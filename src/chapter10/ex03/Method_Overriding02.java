...
public class Method_Overriding02 {
	public static void main(String[] args) {
		...
		//메소드 오버라이딩, 오버라이딩된 메소드 출력	/ 상속이 된 자식 클래스에서만 오버라이딩이 가능
		//Animal의 메소드 호출 시 오버라이딩된 자식의 메소드가 출력
		t1.animalSound();	//Animal의 animalSound 호출 시 오버라이딩 된 Tiger의 animalSound가 출력 
		t2.animalSound();	//Animal의 animalSound 호출 시 오버라이딩 된 Lion의 animalSound가 출력
		t3.animalSound();	//Animal의 animalSound 호출 시 오버라이딩 된 Eagle의 animalSound가 출력
