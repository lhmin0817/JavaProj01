...
class Student{
	...
	//getter(필드이 값을 리턴으로 돌려줌), setter(인풋 값을 받아서 필드에 적용 생성
	...
	//toString() 재정의 : 객체의 Heap 메모리에 주소값이 출력 / hashcode로 출력(16진수)
...
public class Initial_Field01 {
	public static void main(String[] args) {
		...
		// 2. 객체를 생성할 때 생성자를 통해서 필드의 값을 할당
		// 3. DTO(Data Transper Object), VO(Value Object) : 
		//		: client에게 값을 받아서 DAO에 값을 전송하는 역활
		//		DAO : (Data Acess Object) : Data Base에  Insert, Update, Delete
		...
		System.out.println(s1);				//객체를 출력할 때 toString()메소드가 호출
