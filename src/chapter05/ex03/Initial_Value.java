...
public class Initial_Value {
	public static void main(String[] args) {
		...
		//2-1. 기본자료형 배열
		boolean[] arr1 = new boolean[3];	//기본값으로 false가 각 방에 설정
