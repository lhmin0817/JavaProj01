...
public class Sharing_String_Object {
	public static void main(String[] args) {
		...
		//		- new 생성자를 사용해서 객체를 생성할때는 공유되지 않는다.
		...
		System.out.println(str1 == str2);	//false	[생성자로 객체를 생성하여 주소값이 동일하지 않다고 산출]
		System.out.println(str2 == str3);	//true	[리터럴로 객체를 생성하여 주소값이 동일하게 산출]
