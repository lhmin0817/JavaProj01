...
public class String_Object_01 {
	public static void main(String[] args) {
		//참조 자료형 : 객체 (String)
		/*
			String 문자열을 저장하는 자바에서 생성해놓은 객체(첫 글자가 대문자로 시작)
			 	- 다른 객체와 다른 특수한 기능들이 존재한다. 
			
			
		*/
		//1. String으로 객체 생성 방법 1		<== 다른 객체와 별도의 주소에 생성(값을 수정할 수 없다.
		...
		//3. 문자열 수정(객체내의 내용 변경이 불가 ==> 새로운 객체가 생성)
